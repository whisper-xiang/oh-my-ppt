      ...
      <section className="grid gap-6 lg:grid-cols-3">
        ...
        >
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[10%_90%_16%_84%/78%_22%_78%_22%] bg-[#9d90e0] text-white shadow-[0_10px_22px_rgba(93,107,77,0.18)]">
              <FileText className="h-5 w-5" />
            </div>
            <span className="rounded-full bg-[#faf9fe]/84 px-3 py-1.5 text-[11px] font-semibold text-[#6b5fbd] shadow-[0_6px_14px_rgba(86,73,54,0.08)]">
          ...
          <div className="relative mt-7">
            ...
            <p className="mt-3 max-w-[32rem] text-[14px] leading-relaxed text-[#6b5fbd]">
              {t('thinking.quickCreateDescription')}
            </p>
          </div>

          <div className="relative mt-auto pt-7">
            <span className="inline-flex h-11 items-center gap-2 rounded-full bg-[#6b5fbd] px-5 text-[13px] font-semibold text-white shadow-[0_10px_22px_rgba(93,107,77,0.22)] transition-colors group-hover:bg-[#3e4a32]">
        ...
        >
          <div className="pointer-events-none absolute -bottom-12 -left-10 h-36 w-36 rounded-[30%_70%_70%_30%/30%_30%_70%_70%] bg-[#9d90e0]/28 transition-transform group-hover:scale-110" />
          <div className="pointer-events-none absolute right-8 top-9 h-24 w-32 rounded-[8%_92%_12%_88%/78%_22%_78%_22%] bg-[#f5f1e8]/55" />

          <div className="relative flex items-start justify-between gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[10%_90%_16%_84%/78%_22%_78%_22%] bg-[#6b5fbd] text-white shadow-[0_10px_22px_rgba(93,107,77,0.18)]">
          ...
          <div className="relative mt-auto pt-7">
            <span className="inline-flex h-11 items-center gap-2 rounded-full bg-[#3e4a32] px-5 text-[13px] font-semibold text-white shadow-[0_10px_22px_rgba(62,74,50,0.20)] transition-colors group-hover:bg-[#6b5fbd]">
              {creating ? (
                <>
        ...
        >
          ...
          <div className="relative flex items-start justify-between gap-4">
            ...
            <span className="rounded-full bg-[#faf9fe]/84 px-3 py-1.5 text-[11px] font-semibold text-[#4c3fa8] shadow-[0_6px_14px_rgba(86,73,54,0.08)]">
              PPTX
            </span>
          </div>
          ...
          <div className="relative mt-auto pt-7">
            <span className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[#6b5fbd] px-5 py-2 text-[13px] font-semibold text-white shadow-[0_10px_22px_rgba(93,107,77,0.20)] transition-colors group-hover:bg-[#3e4a32]">
              {importingPptx ? (
                <>
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
