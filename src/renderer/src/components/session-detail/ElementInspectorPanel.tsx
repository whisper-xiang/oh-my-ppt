...
export function ElementInspectorPanel({
  ...
  return (
    <div className="mr-3 mb-3 mt-1 flex min-h-0 w-[260px] shrink-0 flex-col overflow-hidden rounded-[2rem] border border-[#d4cef0]/60 bg-[#f3ecdf]/76 shadow-[0_14px_32px_rgba(74,59,42,0.11)] backdrop-blur-xl">
      <div className="relative mx-2.5 mt-2.5 overflow-hidden rounded-[1.35rem] border border-[#e1d6c4]/72 bg-[#faf9fe]/78 px-3 pb-2.5 pt-3 shadow-[0_4px_12px_rgba(77,61,43,0.06)]">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#7a75a0]">
