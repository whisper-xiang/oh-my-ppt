...
export function SpeechScriptDrawer({
  ...
  // Load existing script from file when drawer opens
  useEffect(() => {
    if (!open) return
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[300px] select-none">
        {/* Header tabs */}
        <div className="flex shrink-0 items-end border-b border-[#e2d9cc] bg-[#f5f2ee] px-4 pt-4">
          <button
            type="button"
          ...
          <div className="flex flex-1 flex-col overflow-y-auto px-4 py-5">
              ...
              <div className="grid grid-cols-2 overflow-hidden rounded-xl border border-[#d8ccb5]">
                ...
                >
                  ...
                  <span className="mt-0.5 text-xs text-[#9a8f80]">
                    {currentPageTitle
                      ? currentPageTitle
                      : t('sessionDetail.speechScriptScopeSingleDesc')}
                  </span>
                </button>
              </div>
            </div>
            ...
            <div className="mb-5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  onConfigChange({ ...speechConfig, style: v as SpeechStyle })
                }
              >
            ...
            <div className="mb-6">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  onConfigChange({ ...speechConfig, length: v as SpeechLength })
                }
              >
                <SelectTrigger className="bg-white">
                  <SelectValue />
                ...
                <SelectContent>
                  <SelectItem value="short">
                    {t('sessionDetail.speechScriptLengthShort')}
                  </SelectItem>
                  <SelectItem value="medium">
                    {t('sessionDetail.speechScriptLengthMedium')}
                  </SelectItem>
                  <SelectItem value="long">
                    {t('sessionDetail.speechScriptLengthLong')}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
