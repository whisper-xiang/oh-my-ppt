...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        'z-50 max-w-[320px] rounded-lg border border-[#d4cef0]/85 bg-[#fff9ef] px-3 py-2 text-xs leading-5 text-[#445439] shadow-[0_14px_32px_rgba(88,72,54,0.2)] backdrop-blur-xl',
